...
class CompositionalPlaybackMedia: NSObject, PlaybackMedia, AVAssetResourceLoaderDelegate {
    typealias SubtitleComposition = (url: URL, name: String, language: String)
