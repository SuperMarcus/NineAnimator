...
class NASourceTheWatchCartoonOnline: BaseSource, Source, PromiseSource {
    ...
    #if canImport(UIKit)
    var siteLogo: UIImage { #imageLiteral(resourceName: "WatchOnlineCartoon Site Logo") }
    #elseif canImport(AppKit)
    var siteLogo: NSImage { #imageLiteral(resourceName: "WatchOnlineCartoon Site Logo") }
    #endif
