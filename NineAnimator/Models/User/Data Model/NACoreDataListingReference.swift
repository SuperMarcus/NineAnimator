...
public class NACoreDataListingReference: NACoreDataAnyLink {
    var nativeListingReference: ListingAnimeReference? {
    ...
    convenience init(initialListReference listReference: ListingAnimeReference, context: NSManagedObjectContext) {
