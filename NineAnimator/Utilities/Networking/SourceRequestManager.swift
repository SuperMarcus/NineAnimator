...
class NABaseSourceRequestManager: NARequestManager {
    ...
    func request(_ endpointRelativePath: String, handling: NARequestHandlingDirective = .default, method: HTTPMethod = .get, query: URLQueryParameters? = nil, parameters: Parameters? = nil, encoding: ParameterEncoding = URLEncoding.default, headers: HTTPHeaders? = nil) -> RequestBuilding {
        self.request(
    ...
    private struct EndpointRelativeURLConvertible: URLConvertible {
        weak var parent: NABaseSourceRequestManager?
