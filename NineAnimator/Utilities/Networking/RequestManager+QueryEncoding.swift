...
protocol URLQueryParameterEncoding {
...
struct URLQueryParameterW3CEncoding: URLQueryParameterEncoding {
    func encode(key: String, value: CustomStringConvertible) throws -> URLQueryItem {
...
struct URLQueryParameters: ExpressibleByDictionaryLiteral {
    typealias Key = String
    typealias Value = CustomStringConvertible
    
    var values: [(name: String, value: CustomStringConvertible)]
    var encoding: URLQueryParameterEncoding = URLQueryParameterW3CEncoding()
    
    init(dictionaryLiteral elements: (String, CustomStringConvertible)...) {
        self.values = elements
    }
    
    func appendTo(request: inout URLRequest) throws {
